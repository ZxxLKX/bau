...
TIMES="10"
CHATID="1734868055"
KEY="5914020137:AAH7cRBSyXi8vvJbXnRK35OeIng8JBVO86c"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To NATO STORE SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}NATO STORE ® ${NC}${YELLOW}(${NC} ${green} NATO STORE ${NC}${YELLOW})${NC}"
echo -e " © NATO STORE ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
Exp1=$(curl https://raw.githubusercontent.com/ZxxLKX/bau/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ZxxLKX/bau/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/ZxxLKX/bau/main/izin | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/ZxxLKX/bau/main/izin | grep $MYIP | awk '{print $3}')
...
<code>────────────────────</code>
<b>   NATO STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6285335903344"}]]}' 
#"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ2","url":"https://wa.me/6285335903344"}]]}'
